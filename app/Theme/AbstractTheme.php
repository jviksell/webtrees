...
abstract class AbstractTheme {
	...
	const ASSET_DIR  = 'themes/' . self::THEME_DIR . '/css-1.8.0/';
	...
	public function bodyHeader() {
		return
			...
			'<div class="wt-header-container container">' .
			'<div class="wt-header-content row">' .
			$this->headerContent() .
			'</div>' .
			'</div>' .
			'</header>' .
			'<main id="content" class="wt-main-wrapper">' .
			'<div class="wt-main-container container">' .
	...
	protected function primaryMenuContainer(array $menus) {
		return '<nav class="wt-primary-navigation"><ul class="nav wt-primary-menu">' . $this->primaryMenuContent($menus) . '</ul></nav>';
	}
